...
export default function SearchForm() {
    ...
    return ( 
        <div className="min-h-screen bg-blue-950 flex flex-col items-center justify-center relative">
            <div className="w-full max-w-2xl fixed top-1/4 left-1/2 transform -translate-x-1/2 z-10">
                ...
                <div
                    ...
                    style={{ maxHeight: '0' }}
                >
                    <h2 className="text-blue-950">Select Your Allergies</h2>
            ...
            <div> {results.map((item, index) => (
                <div key={index}> 
                    <h2>{item.name}</h2> 
                    <p>{item.author} - {item.type.primary} - {item.type.secondary}</p> 
                    ...
                    <p>Date Posted: {item.published_at}</p>
                    <h3>Comments</h3>
